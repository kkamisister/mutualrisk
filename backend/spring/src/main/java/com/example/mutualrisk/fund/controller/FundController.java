...
import com.example.mutualrisk.fund.dto.FundResponse.PortfolioReturnDto;
...
public class FundController {
	...
	@GetMapping("/history")
	public ResponseEntity<ResponseWithData<List<PortfolioReturnDto>>> getHistory(@RequestParam("period") Integer period,
		...
		ResponseWithData<List<PortfolioReturnDto>> fundHistory = fundService.getHistory(userId, company, period);
